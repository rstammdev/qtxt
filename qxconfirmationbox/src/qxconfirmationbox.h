...
public:
    ...
    static StandardButton continueCancelCritical(QWidget* parent, const QString& title, const QString& text, const QString& informativeText = QString(), const QString& key = QString());
